    ...
    <div class="mdl-card__supporting-text">
      <div class="mdl-stepper-horizontal-alternative" >
        ...
        <div class="mdl-stepper-step active-step"
             :class="[[stepNumber > step.number ? 'step-done' : ''],
             [stepNumber == step.number ? 'editable-step is-step' : '']
             ]"
             v-for="step in steps">
          <div class="mdl-stepper-circle" >
            <span>
              {{ (step.number == stepNumber) ? "..." : (stepNumber > step.number ? '' : step.number+offset) }}
            </span>
          </div>
          <div class="mdl-stepper-title"
               :class="stepNumber == step.number ? 'is-step' : ''"
          >{{step.name}}</div>
