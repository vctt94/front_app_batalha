...
export default {
    ...
    methods: {
        ...
        getInstitutions: function() {
            console.log('called')
            this.$http.get('https://apicivil.maquinadeaprovacao.com/api/institution/get-institutions/').then(response => {
        ...
        getJurys: function() {
            this.$http.get('https://apicivil.maquinadeaprovacao.com/api/jury/get-jurys/').then(response => {
        ...
        getTests: function() {
            this.$http.get('https://apicivil.maquinadeaprovacao.com/api/test/get-tests/').then(response => {
